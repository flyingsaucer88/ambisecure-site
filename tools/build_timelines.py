...
TIMELINES = [
    ...
    },
    {
        ...
        'entries': [
            ...
            ('2022', 'IoT-grade secure elements at scale', 'Purpose-built secure elements for connected devices: I&sup2;C / SPI interface, low power, attestation primitives, signed-firmware verification. The IoT SE category matures.', '<a href="/products/iot-security-coprocessor/">IoT Security Co-Processor</a>'),
        ...
        'related': [
            ('/technologies/secure-elements/', 'Technology: secure elements'),
            ('/products/iot-security-coprocessor/', 'Product: IoT Security Co-Processor'),
...
<footer class="site-footer"><div class="footer-inner">
  <div class="footer-grid">
    ...
    <div><h4>Products</h4><ul><li><a href="/products/onepass-platform/">OnePass Platform</a></li><li><a href="/products/onepass-card/">OnePass Card</a></li><li><a href="/products/onepass-usb-key/">OnePass USB Key</a></li><li><a href="/products/javacard-applets/">JavaCard Applets</a></li><li><a href="/products/iot-security-coprocessor/">IoT Security Co-Processor</a></li><li><a href="/products/">All products</a></li></ul></div>

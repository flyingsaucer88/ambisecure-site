/* AmbiSecure — curated AAGUID directory.
   AAGUIDs identify the make/model of a FIDO2 authenticator. The official
   source of truth is the FIDO Metadata Service (MDS) BLOB; this dictionary
   is a static, hand-curated subset of well-known consumer/enterprise
   authenticators for offline lookup. For production attestation validation
   you should fetch and verify the MDS BLOB. */
(function (root) {
  'use strict';
  var DICT = {
    // YubiKey family
    ...
    // Microsoft Windows Hello / platform
    ...
    // AmbiSecure (placeholder — own AAGUIDs are issued per FIDO certification)
  ...
  // Format a 16-byte AAGUID buffer as canonical string xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx
